...
_G.Settings = {
    ...
    TeleportGear = true,
    AutoNewWorld = true,
    TweenToFruitSpawn =  true,
    AutoSaber =  true,
    AutoPole =  true,
    TeleportIsland =  true,
    AutoThirdSea =  true,
    AutoBartiloQuest =  true,
    Auto_Evo_Race_V2 =  true,
    AutoDarkCoat =  true,
    AutoSwanGlasses =  true,
    AutoTrueTriplKatana =  true,
    AutoRengoku =  true,
    AutoEctoplasm =  true,
    AutoFactory =  true,
    AutoRainbowHaki =  true,
    AutoBuyEnchanmentHakiHop =  true,
    AutoBuyLegendarySwordHop =  true,
    AutoEliteHunter =  true,
    AutoMusketeerHat =  true,
    AutoBuddySword =  true,
    AutoFarmBone =  true,
    SpawnBossHallow =  true,
    AutoKenHakiV2 =  true,
